...
/**
 * This class is used by {@link cb.alphabeta.AlphaBeta AlphaBeta} to run a
...
public class SearchWorker extends Thread {
	...
	/**
	 * Initializes a new {@link cb.alphabeta.SearchWorker SearchWorker} thread.
	 * 
	 * @param game
	 ...
	 *            The game position that should be searched through.
	 * @param maxDepth
	 *            The maximum depth that the {@link cb.alphabeta.SearchWorker
