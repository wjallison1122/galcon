 ...
 * {@link cb.alphabeta.AlphaBeta AlphaBeta}.
 * 
...
public interface Position {
	 ...
	 * 
	 * @return the list of valid {@link cb.alphabeta.Move moves}.
	 */
	 ...
	 * whether the move is valid or not, since {@link cb.alphabeta.AlphaBeta
	 * AlphaBeta} only iterates through {@link #getMoves() valid moves}.
	 * 
	 * @param move
	 *            a valid {@link cb.alphabeta.Move move}.
	 */
	public void doMove(Move move);

	/**
	 * Get the last executed {@link cb.alphabeta.Move move} from the moves stack
	 * and undo it.
	 */
