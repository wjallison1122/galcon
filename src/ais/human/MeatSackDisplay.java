...
public class MeatSackDisplay extends JPanel {
   ...
   private static enum State
    ...
    public JPanel getControlPanel() {
        ...
        final EButton autoAdvanceButton = new EButton(
                player.getAutoAdvance() ? "Turn Auto Advance Off" : "Turn Auto Advance On");
    ...
    public BufferedImage getFrame() {
        ...
        if (interfaceState == State.SEEKING) {
            ...
            drawPointer(selectedPlanet, destinationPlanet.getCoords()[0] * SCALE,
                    destinationPlanet.getCoords()[1] * SCALE, g);
        }
